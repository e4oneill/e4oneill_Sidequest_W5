class BlobPlayer {
  constructor() {
    ...
    // Movement (calmer feel)
    this.accel = 0.6;
    this.maxRun = 4.2;

    // Floaty calm jump tuning
    this.gravity = 0.45;
    this.jumpV = -15.5;
  ...
  update(level) {
    ...
    let progress = constrain(1 - this.y / level.h, 0, 1);

    // slow movement slightly near night sky
    let slowFactor = lerp(1.0, 0.75, progress);
